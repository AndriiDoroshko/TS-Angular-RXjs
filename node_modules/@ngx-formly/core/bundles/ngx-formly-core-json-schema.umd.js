(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function totalMatchedFields(field) {
        if (!field.fieldGroup) {
            return field.key && core.ɵgetFieldValue(field) !== undefined ? 1 : 0;
        }
        /** @type {?} */
        ...
        if (total === 0 && field.key) {
            /** @type {?} */
            var value = core.ɵgetFieldValue(field);
            if (value === null
                || ((value !== undefined)
    ...
    var FormlyJsonschema = /** @class */ (function () {
         ...
         */
            function (schema, _a) {
                ...
                if (key && options.strict) {
                     ...
                     */function (c, f) {
                        /** @type {?} */
                        var value = core.ɵgetFieldValue(f);
                        if (value != null) {
                            switch (field.type) {
                                case 'string': {
         ...
         */
            function (field, schema, options) {
                /** @type {?} */
                var model = field.model ? core.ɵclone(field.model) : (field.fieldArray ? [] : {});
                var form = (( /** @type {?} */(field.options)))._buildField({
                    form: Array.isArray(model) ? new forms.FormArray([]) : new forms.FormGroup({}),
                    fieldGroup: [this._toFieldConfig(schema, __assign({}, options, { resetOnHide: true, ignoreDefault: true, map: null, strict: true }))],
                    model: model,
                }).form;
                return form.valid;
            };
