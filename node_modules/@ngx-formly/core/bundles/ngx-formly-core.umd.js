    ...
    ***************************************************************************** */
    ...
    function clone(value) {
        if (!isObject(value)
            ...
            || (value instanceof i0.TemplateRef)
    ...
    var FormlyValidationMessage = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.errorMessage$ = rxjs.merge(this.field.formControl.statusChanges, (!this.field.options
                    ? rxjs.of(null)
                    : this.field.options.fieldChanges.pipe(operators.filter(( /**
                     * @param {?} __0
                     * @return {?}
                     */function (_a) {
                    ...
                    }))))).pipe(operators.startWith(null), operators.switchMap(( /**
             * @return {?}
             */function () {
         ...
         */
            function (field, disabled) {
                ...
                if (field.key || !field.parent || (!field.key && !field.fieldGroup)) {
                    ...
                    if (field.key && c_1 && c_1 instanceof forms.FormControl) {
    ...
    exports.ɵgetFieldValue = getFieldValue;
